...
% Preparación y enumeración de mallas
...
% Enumeración de los lados 
nvel=size(v,1);
[E,DOF,mesh,efree]=edgesenum(M,B,v,mesh,h,free,MC,n);



% Dos lados derecho: una para cada parte del sistema 
% Cambian los grados de libertad y las funciones base
...
%No se usa (otras pruebas)
Gepsilon=[GCR(:,efree),myeps*GL(:,list2)];

% Matriz G general
G=[GCR(:,efree),GL(:,list2)];
% efree: Lista de todos los lados interiores (CR)
% list2: Todos los vértices, menos uno (P1 Neumann) 
