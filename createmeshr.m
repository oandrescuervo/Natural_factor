...
h.hx=hx;
h.hy=hy;
v=zeros(nvel,2);   %v guarda los vértices (primera columna coordenada en x y segunda columna coordenada en y)
M=zeros(ne,3);     %M guarda las coordenada de los vértices de cada elemento
MC=zeros(ne,2);
for iy=1:ney+1
    for ix=1:nex+1
