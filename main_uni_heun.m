...
% "Heun 2 - atrás"
M_t4=M1+dt/2*(M1*(A1-A0)*M1+M_t1*(A1-A0)*M_t1);
% "Promedio_euler"
%M_t4=(M_t1+M_t0)/2;
% "Promedio_heun new"
M_t5=(M_t4+M_t3)/2;
...
[xLU0, errorLU0, iterLU0, flagLU0, lambdamaxLU0, condnumberLU0] =ApcgCR2(b*0, b,b, 20000, 0.000001, ABD,M1);
[xLU2, errorLU2, iterLU2, flagLU2, lambdamaxLU2, condnumberLU2] =ApcgCR2(b*0, b,b, 20000, 0.000001, ABD,M_t0);
[xLU3, errorLU3, iterLU3, flagLU3, lambdamaxLU3, condnumberLU3] =ApcgCR2(b*0, b,b, 20000, 0.000001, ABD,M_t2);
[xLU4, errorLU4, iterLU4, flagLU4, lambdamaxLU4, condnumberLU4] =ApcgCR2(b*0, b,b, 20000, 0.000001, ABD,M_t3);

[xLU41, errorLU41, iterLU41, flagLU41, lambdamaxLU41, condnumberLU41] =ApcgCR2(b*0, b,b, 20000, 0.000001, ABD,M_t4);
[xLU5, errorLU5, iterLU5, flagLU5, lambdamaxLU5, condnumberLU5] =ApcgCR2(b*0, b,b, 20000, 0.000001, ABD,M_t5);
[xLU6, errorLU6, iterLU6, flagLU6, lambdamaxLU6, condnumberLU6] =ApcgCR2(b*0, b,b, 20000, 0.000001, ABD,M_t6);
...
% media_ncond_promH2=mean(ncond_promH2)
...
% var_ncond_promH2=var(ncond_promH2)
...
media_iter_pc=mean(Iter1)
media_iter_pc2=mean(Iter10)
media_iter_Euler=mean(Iter2)
media_iter_heun_ant=mean(Iter3)
media_iter_heun_new=mean(Iter4)
media_iter_heun_new2=mean(Iter41)
media_iter_prom_heun_ant=mean(Iter6)
media_iter_prom_heun_new=mean(Iter5)